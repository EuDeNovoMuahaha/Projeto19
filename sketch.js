...
function draw() {
  ...
  case 1: obstacle.addAnimation(oppPink1Img);
          break;
  case 2: obstacle.addAnimation(oppYellow1Img);
          break;
  case 3: obstacle.addAnimation(oppRed1Img);
          break;
  default: break;
  }
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    text("pressione UpArrow para reiniciar", 650, 125)
    textSize(25)
